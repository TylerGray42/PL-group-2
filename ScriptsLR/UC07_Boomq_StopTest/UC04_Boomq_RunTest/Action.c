Action()
{
	...
	lr_start_transaction("TR04_Run_test");
	...
	lr_end_transaction("TR04_Run_test",LR_AUTO);

	lr_think_time(26);

	lr_start_transaction("TR05_Test_details");
	...
	lr_end_transaction("TR05_Test_details",LR_AUTO);
	...
	lr_start_transaction("TR06_Detailed_stats");
	...
	lr_end_transaction("TR06_Detailed_stats",LR_AUTO);
